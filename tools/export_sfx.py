...
`#48/#49/#50/#51/#52/#53/#64/#78/#88` 是動態候選池，`#82/#84` 分別是 command 0／3
由 `0x2A6BD→0x26152/0x26795` 證實的 actor／handler 音效資源，`#95` 是 0x32999
...
BATTLE_EXPORT_INDICES = [48, 49, 50, 51, 52, 53, 64, 78, 82, 84, 86, 87, 88, 95]

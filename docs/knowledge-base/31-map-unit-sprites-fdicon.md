...
- `tools/export_units.py`:`fig = portrait`(恆等;§6 反組譯確認,非對應表),寫進 units.json。
...
- 原版實機截圖(`real_pic/`)當 oracle:已用它**驗證 fig=portrait**(索爾/哈諾/鐵諾/士兵/盜賊/豹人/騎士/暗戰士 11/11 對上,§6),非用來猜對應。

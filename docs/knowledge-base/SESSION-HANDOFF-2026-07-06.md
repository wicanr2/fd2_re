...
- 2026-07-20 AI spell-family candidate slice：新增 `State.AISpellCandidates`，依 direct `0x15B77` family 分支提供 attack(0..12)、heal(13..16)、buff(17..19)、status(20..22/26/27) 的 live/camp 候選掃描；保留 runtime order，不猜原版分數與施法執行。

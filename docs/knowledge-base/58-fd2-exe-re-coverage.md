...
| 對話、頭像與過場原語 | 部分偏高 | ch00_pre 97句、ch00_post 13句、ch01_pre 20句、ch06_post 12句、ch07_post 8句、ch12_post 12句、ch17_post 21句、ch19_post 29句、ch22_post 56句與ch24_post 18句原生版面就緒 | 部分 E1 | 部分 | 十個已接切片均由raw控制碼建成typed pages。第7戰後active／inactive兩路分別正式播放8／4句，正確決定JOIN12，再進`town_ch08`與存讀檔；第8戰後29／41 slots邊界亦完成8句、全黑、JOIN5、同步、`town_ch09`與存讀檔。第13、18、20、23戰後保持各自分支、入隊與城鎮／整備邊界。只重開E2或其他caller binding，不重做已閉合renderer。 |

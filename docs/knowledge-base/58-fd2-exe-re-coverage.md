...
archive刻意缺FDICON.B24仍載入成功，達戰場bundle的`RUNTIME-E1`。整備、職業／教會、
城鎮與終局tail仍是獨立archive consumer，所以全runtime只標`RUNTIME-E1-PARTIAL`，不以
本項宣稱FDFIELD／FDSHAP或整張戰場畫面E2。

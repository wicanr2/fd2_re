...
| 對話、頭像與過場原語 | 部分偏高 | ch00_pre 97句、ch00_post 13句、ch01_pre 20句、ch06_post 12句、ch07_post 8句、ch09_post 35句、ch12_post 12句、ch15_post 23句、ch16_post 26句、ch17_post 21句、ch19_post 29句、ch22_post 56句與ch24_post 18句原生版面就緒 | 部分 E1 | 部分 | 十三個已接切片均由raw控制碼建成typed pages。第10戰後60／61兩路均正式播放35句，保持DAC／sparse patch順序，JOIN11／6並進`town_ch11`與存讀檔；第7、8、13、16、17、18、20、23戰後亦保持各自分支、入隊與城鎮／整備邊界。只重開E2或其他caller binding，不重做已閉合renderer。 |

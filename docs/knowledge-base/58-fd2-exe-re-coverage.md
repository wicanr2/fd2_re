...
| `0x1088D`／`0x33DBA`／`0x35C79`／`0x35C32`／`0x35D60`／`0x35EE6`／`0x2548C`（map28） | [`fd2_map28_runtime_topology_ida.txt`](../data/ida/fd2_map28_runtime_topology_ida.txt) | 玩家第29戰入口20筆持續隊伍＋group8(56)=76；event75 selector1 與 event74 groups4..7 已成為可編輯資料及正式 `RUNTIME-E1`；event76→group1／event79 consumer、post group9 的 producer/order 已閉合但 runtime 尚未接。groups2/3無已證實producer | 接 typed event76／79、ch28 post binding與E2；event75／74僅在新反證下重開，event82只有新producer證據才可重開 |

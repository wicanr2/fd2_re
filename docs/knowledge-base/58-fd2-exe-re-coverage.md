...
| 對話、頭像與過場原語 | 部分偏高 | ch00_pre 97句、ch00_post 13句、ch01_pre 20句、ch05_post 19句、ch06_post 12句、ch07_post 8句、ch09_post 35句、ch12_post 12句、ch15_post 23句、ch16_post 26句、ch17_post 21句、ch19_post 29句、ch21_post 11句、ch22_post 56句、ch23_post 11句與ch24_post 18句原生版面就緒 | 部分 E1 | 部分 | 十六個已接切片均由raw控制碼建成typed pages。第24戰後兩個caller現以正式輸入播放11句，86-slot路徑保持跨scene映射、stage2..14、同步、`preparation_ch25`與存讀檔；第6、7、8、10、13、16、17、18、20、22、23戰後亦保持各自分支、入隊與城鎮／整備邊界。只重開E2或其他caller binding，不重做已閉合renderer。 |
...
| `0x2415B`、`0x2425F`、`0x2429A`、`0x24336` | [`fd2_ch20_sky_key_sequence_ida.txt`](../data/ida/fd2_ch20_sky_key_sequence_ida.txt) | 玩家第21戰戰後26-slot layout、ACT63／64與天空之鑰固定演出：`FDOTHER #34`、`ANI #0`、調色盤與延遲順序；正式重製端 E1 已依序消費並進城鎮／存讀檔 | 只補未修改原版同狀態 E2與第一個動態調色盤相位；不重解函式本體、layout或ACT resources |

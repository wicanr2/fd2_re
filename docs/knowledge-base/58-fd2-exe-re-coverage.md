...
| 對話、頭像與過場原語 | 部分偏高 | ch00_pre 97句、ch00_post 13句、ch01_pre 20句、ch12_post 12句、ch17_post 21句、ch19_post 29句、ch22_post 56句與ch24_post 18句原生版面就緒 | 部分 E1 | 部分 | `0x15F84`、`0x1366A`、基本 pan／acting／spawn／join 等不應再從零重解。八個已接切片均由raw `FFEC..FFEF/FFFE/FFFD`建成typed pages；[`fd2_story_dialogue_layout_ida.txt`](../data/ida/fd2_story_dialogue_layout_ida.txt)閉合五階段開框、逐字、完整頁嘴型、三列窗口捲動、snapshot收框與可選游標尾段。raw glyph上限須依control取13／15／14／14，且不能用Unicode rune數代替。第13戰後12句保持跨scene順序，再同步15人、JOIN3、進`town_ch14`；第18戰後21句再JOIN21／7、進`town_ch19`；第20戰後round15播放29句、84 slots與JOIN25／28，round16播放共同15句、83 slots與JOIN25，兩路都進`town_ch21`並通過存讀檔；第23戰後正式分支另完成35句、同步、冷讀及整備至`story_ch24`。只重開E2或其他caller binding；不把重製更新分配冒稱DOS精確時鐘。 |

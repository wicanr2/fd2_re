...
| `0x16F55`、`0x117E7` | [`fd2_end_turn_command13_owner_ida.txt`](../data/ida/fd2_end_turn_command13_owner_ida.txt)、[`empty cursor owner`](../data/ida/fd2_117e7_empty_cursor_system_overlay_ida.txt)、[`END確認框`](../data/ida/fd2_end_turn_confirmation_ui_ida.txt) | `0x12C0D==-1` 空游標 owner、direction3→END、DATO #75／FDOTHER #5/#2 indexed確認生命週期、FDTXT `0x1A3/0x1A4/0x19C`、YES／NO、`0xC8` ms、來源復原、`0x1A30B` 與正式 battle E1 | 精確 DOS tick／音訊、其他三格 owner、逐章同狀態重製E2；不重解 END 分支與已閉合renderer |

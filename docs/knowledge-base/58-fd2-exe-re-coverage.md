...
| `0x1D6C8`（command 17–22 玩家 palette owner） | [`fd2_command_modifier_palette_ida.txt`](../data/ida/fd2_command_modifier_palette_ida.txt) | 唯一caller `0x1CFF0`、#88 sub0、三張36-byte DAC table、四輪color／black；17–22玩家正式E1均先演出後交易 | 補phase-expiry caller、status UI、精確tick與逐音訊E2；不重解palette loop |

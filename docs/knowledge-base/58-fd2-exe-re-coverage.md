...
| `0x2415B`、`0x24182`、`0x2424B`、`0x24286`、`0x242C1`、`0x24308`、`0x2425F`、`0x2429A`、`0x24336` | [`fd2_ch20_sky_key_sequence_ida.txt`](../data/ida/fd2_ch20_sky_key_sequence_ida.txt) | 玩家第21戰戰後26-slot layout、六個branch tuple共30句原生對話、ACT63／64與天空之鑰固定演出；正式成功臂已依序消費26句、`FDOTHER #34`、`ANI #0`、調色盤與延遲，再進城鎮／存讀檔 | 只補材料不足臂正式玩家輸入與未修改原版同狀態 E2、第一個動態調色盤相位；不重解函式本體、對話tuple、layout或ACT resources |

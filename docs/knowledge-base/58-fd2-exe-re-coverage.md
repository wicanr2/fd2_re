...
| 對話、頭像與過場原語 | 部分偏高 | ch00_pre 97句、ch00_post 13句、ch01_pre 20句與ch24_post 18句原生版面就緒 | 部分 E1 | 部分 | `0x15F84`、`0x1366A`、基本 pan／acting／spawn／join 等不應再從零重解。四個已接切片均由raw `FFEC..FFEF/FFFE/FFFD`建成typed pages；[`fd2_story_dialogue_layout_ida.txt`](../data/ida/fd2_story_dialogue_layout_ida.txt)閉合五階段開框、逐字、完整頁嘴型、三列窗口捲動、snapshot收框與可選游標尾段。序章97句後正式第1戰勝利進`ch00_post`，13句全部收框後才同步5人persistent roster並進`town_ch02`；其後整備冷讀、第2戰前20句與`battle_ch02`仍連續通過，見[`ch00-post-native-dialogue-e1.json`](../data/ui-traces/ch00-post-native-dialogue-e1.json)。第25戰戰後另完成18句並抵達town26／祕密商店。序章map32兩筆缺constructor來源的特殊劇情角色只在私有背景clone採99%保守前景近似，不污染戰鬥或存檔；見[`ch00-pre-native-dialogue-e1.json`](../data/ui-traces/ch00-pre-native-dialogue-e1.json)。只重開E2或其他caller binding；不把重製更新分配冒稱DOS精確時鐘。 |

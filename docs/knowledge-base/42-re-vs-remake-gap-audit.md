...
| 敵方 AI:目標評分(dmg、擊殺加成×2) | doc11 | 🟡 | `combat.go aiActUnit/NextAIPlan`:有 dmg(現透過 `estDamage` **已套地形 AP/DP%**,doc11 核心公式的另一半本輪補上)與「dmg≥HP→score×2+1000」的擊殺加成簡化版,但**仍無「dmg≤2 略過」門檻**、**無情境加成(0x1529E)、無狀態倍率×1.5(0x152AB)** | 中 |

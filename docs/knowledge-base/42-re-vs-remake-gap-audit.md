...
| native IDs32–35 compound | SDD56 UI-03 | 🟡 | ID34已依class19可達selector、record34 MP gate與17→18→19 raw helper順序接成玩家原子state transaction；不扣MP只限已證實繞過debit sink的group4／5／6／7／20。ID32／33／35、`0x27FC9` indexed UI/SFX與E2仍未閉合；禁止以legacy combo外推 | 高 |

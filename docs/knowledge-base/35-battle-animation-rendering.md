...
- **刪除的錯誤推測**(本輪推翻,省 token):① 「圓圈 = BG.DAT 前景層 `[0x5410b/0f/13]`」(BG dump 只有天空/山/草地/樹幹,無土台圈層,
  且圓圈 y≈160–180 已超出 BG 貼圖範圍 y50–150);② 「圓圈 = `FIGANI_012` 自帶小 dither」(用錯幀,實為 `FIGANI_013` 動作1 的大橢圓)。

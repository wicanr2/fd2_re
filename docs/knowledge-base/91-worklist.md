...
| 5 | 戰場與戰間 UI 收尾 | UI-03、UI-07～12 仍 partial；故事對話現接`ch00_pre`97句、`ch00_post`13句、`ch01_pre`20句、`ch12_post`12句、`ch17_post`21句、`ch19_post`29句、`ch24_post`18句及raw`ch22_post`56句。第20戰後round15／16已分別以正式輸入播放29／15句，保留83／84 frontier、JOIN25／28、`town_ch21`與存讀檔；其他已接切片亦完成各自持續隊伍邊界。raw glyph格數已與Unicode rune數分離。 | 八個已接故事切片只剩未修改同狀態E2；下一個候選應從已有正式路徑且canonical RE充分的未接caller挑選，不重做已接切片。標題、教會與service2／3只留既有E2限制；第29戰已結案。 |

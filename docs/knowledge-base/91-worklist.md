...
> 與繁中實體目錄三方一致確認謝多；原版頭像以最近鄰放大後確認為深藍灰毛
> 鼠人忍者，具大型圓鼠耳、向右鼠吻、長鬍鬚、淺色眼、外露門牙與深色高領。
> 識別字依重製英文實體目錄採 `Seymour`；現代主題現有 24 位私有頭像候選。
> `fd2-assets-private` 提交 `7e72b282` 已保存母稿與執行期 PNG；私人 manifest
> 現為 75 個 catalog allow-list 檔案，逐檔大小與 SHA-256 驗證通過。
>

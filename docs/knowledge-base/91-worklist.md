...
| 5 | 戰場與戰間 UI 收尾 | UI-03、UI-07～12 仍 partial；故事對話現接十八個切片。新增`ch25_post`41句可編輯資料與兩條正式勝利路徑：正常57-slot入口分別消費18／33句，再走ACTING77–80、`town_ch27`與全新`Game`冷讀。舊唯一70-slot斷言已由正常玩家測試推翻。 | 十八個已接故事切片只剩未修改同狀態E2；`ch25_post`不再列為未接caller。下一個故事切片只有在canonical caller／consumer證據充分時才開啟；第29戰已結案。 |

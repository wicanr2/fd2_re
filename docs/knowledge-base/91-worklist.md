...
| 5 | 戰場與戰間 UI 收尾 | UI-03、UI-07～12 仍 partial；故事對話現接十五個切片。新增`ch21_post`11句：73／79-slot兩條正式輸入路徑都保持layout、ACTING／PAN、indexed transition、同步與`preparation_ch23`存讀檔邊界；第6、7、8、10、16、17戰後亦保持各自分支與城鎮／整備邊界。 | 十五個已接故事切片只剩未修改同狀態E2；下一個候選為canonical RE與正式路徑均已具備的`ch23_post`兩caller／11句，不重做已接切片；第29戰已結案。 |

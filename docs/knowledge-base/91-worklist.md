...
| 4 | 玩家指令／法術／物品與敵方 AI 完整交易 | 敵方ID0已接完整presenter；ID1的#19/#21每目標31張、八個HP marker、九張boundary與共同tail已由正式owner接入玩家／敵方。ID2的單frame/repeat helper、29張front、每target12張／六HP marker、每boundary九張、10張handler tail、共同tail與#83 sample0..3亦已由同一正式owner接入玩家／敵方。ID6的#32/#33/#87、7張front＋每target12張＋九張boundary＋七張tail同樣完成；三者的MP、HP、`Acted`與RNG皆依Draw發布並可整批回復，達indexed `RUNTIME-E1` | 依正常producer頻度處理ID5／4／7／3；ID1／2／6只留逐呼叫音訊與未修改原版同狀態E2，不重做已閉合handler |

...
| 5 | 戰場與戰間 UI 收尾 | UI-03、UI-07～12 仍 partial；故事對話現接十四個切片。新增`ch05_post`19句：正式輸入保持JOIN13→group3→PAN→ACTING27→19句→sync，完成40→41 slots、`town_ch07`與存讀檔；第7、8、10、16、17戰後亦保持各自分支與城鎮邊界。 | 十四個已接故事切片只剩未修改同狀態E2；下一個候選從已有正式路徑且canonical RE充分的未接caller挑選，不重做已接切片；第29戰已結案。 |

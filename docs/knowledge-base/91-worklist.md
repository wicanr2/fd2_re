...
| 順序 | 工作 | 現況 | 下一個可驗收結果 |
|---:|---|---|---|
| 即時勘誤 | A4／A5 數字 | 2026-09-01 已推送約拿圖組後，現代地圖人物為 selector 0–21、68，共 23 組／276 幀；人工審校累計為日文 332、英文 323、簡中 300 筆。下方 A4／A5 長列仍是上一批快照，其數字欄不得覆蓋本列與後段逐批收據 | 下一次整理長列時直接由 catalog 與語系檔重算，不手抄舊數字 |

...
| 5 | 戰場與戰間 UI 收尾 | UI-03、UI-07～12 仍 partial；故事對話現接十一個切片。新增`ch15_post`23句：round／inactive／word42四路以正式輸入分別完成8／8／0／15句、JOIN18正反例、`town_ch17`與存讀檔；第7、8戰後亦保持各自分支與城鎮邊界。 | 十一個已接故事切片只剩未修改同狀態E2；下一個候選從已有正式路徑且canonical RE充分的未接caller挑選，不重做已接切片；第29戰已結案。 |

...
| A5 | 繁中／簡中／日文／英文與可調文字顯示 | `DATA-READY（5,176筆／語）＋RUNTIME-E1-PARTIAL`：35份劇本共1,564句具穩定 `line_id`；正式 story、handler dialog及事件61／75／76均查詢四語內容。非繁中原生 indexed 對話已重建安全分頁並依裁決固定閉嘴。FDTXT清冊現涵蓋200個可顯示物品與15個confirmed-empty ID；四語全部名稱通過67×16矩形，出售／轉移持有物已接正式ID重畫。32名角色目錄則供商店動態訊息及出售、轉移、裝備、消耗品購買對象、教會等共用兩欄名冊，完整字形與100×16矩形測試通過。F4原子驗證介面、內容與實體目錄。英文／日文其餘內容仍是機器初稿，尚無正常玩家截圖 E2 | 接三列裝備比較名冊、戰鬥HUD、商店／教會服務按鈕、法術名稱及四語正常玩家畫面；再進行人工語文審校。4筆劇情身份歧義不與0–31隊伍顯示目錄合併 |

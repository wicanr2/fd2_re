...
3. **戰鬥交易完整性**：物品 type 5–24與ID33／34受限玩家state transaction不再列數值缺口；狀態到期owner與raw indicators已接。command28／31無已證實一般玩家取得來源，不列阻擋。仍須關閉實際可達的ID32／35、其他未知法術／複合效果、狀態高階名稱，以及代表性玩家／敵方回合的精確演出順序。

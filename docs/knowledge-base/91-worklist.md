...
| 4 | 玩家指令／法術／物品與敵方 AI 完整交易 | 敵方ID0已接完整presenter；ID1／2／5／6均已有玩家／敵方indexed owner、逐Draw發布及整批回復。ID7現已閉合#37/#38/#88、四組初始化／三組render、toggle雙張、2／32／9／16持續state、七個raw marker／五段HP，達`RE-CLOSED`／`DATA-READY`；其`command_learn`有正常玩家升級取得來源，尚未接正式owner。ID5音訊ABI已勘誤為sub0 actor、兩個handler handle同用sub1 | 下一個結果是把ID7 typed planner／compositor接入玩家與敵方正式owner；之後依已證實producer處理ID3，再評估無玩家取得證據的ID4。ID1／2／5／6不重做已閉合handler |

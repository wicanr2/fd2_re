...
| 4 | 玩家指令／法術／物品與敵方 AI 完整交易 | 敵方ID0已接完整presenter；ID1已完成#19/#21九張target compositor；ID2已完成#26/#27單張target compositor與#83 sample。ID6已完成#32/#33/#87、`fcos/fsin`五點座標、十二張mode4→target→mode5 compositor；共用owner另已閉合7幀mode1→2前導、五段HP、7幀mode8→7尾段，typed傷害交易不再錯套ID0七段。正式AI的ID1/2/6仍是state-only數值路徑，不能冒稱畫面E1 | ID6下一步把已閉合的前導／target／尾段接成正式Game presenter，再接正常producer；ID1/2仍須閉合外層MP／HP／音訊發布owner。其後依頻度處理ID5／4／7／3。ID8現行map無敵方mask，僅新producer證據才提升；ID9–12仍須閉合各自owner |

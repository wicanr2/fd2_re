...
| 4 | 玩家指令／法術／物品與敵方 AI 完整交易 | 敵方ID0已接完整presenter；ID1／2／3／5／6／7／8均已有玩家／敵方indexed owner。ID9已分離玩家`0x214AD`與敵方`0x275D6`：玩家 #80 selector0／14／15、八段色盤、#6 27張、#5 result 22張及原子交易已達`RUNTIME-E1`；敵方raw-side-zero #44/#90、11/20/60/20/8、mode11 producer target與20段HP亦達`RUNTIME-E1`。 | 下一個結果是依正常producer完成IDs10–12 `0x21548` family。ID9兩條視覺不可共用，敵方raw side非零失敗即關閉；ID4無已證實正常玩家producer，暫不列交付阻擋；ID1／2／3／5／6／7／8／9不重做 |

...
| 4 | 玩家指令／法術／物品與敵方 AI 完整交易 | 多項正式E1維持；敵方17–19不套玩家palette；mode2／`0x1548E`先預檢FIGANI再交易。敵方ID0現依`Raw53AF9==0`必經既有完整`0x2A6BD→0x26152` presenter，缺場景／資產零MP／HP交易，完成後才走敵方continuation與死亡獎勵 | 下一步逐一閉合正常敵方回合有producer的ID1–8 `funcs_2AC25` entry；不可把ID0專屬#18／#20 schedule外推。ID9–12與command29也必須先證明各自路由／owner |

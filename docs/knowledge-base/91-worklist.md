...
| 5 | 戰場與戰間 UI 收尾 | UI-03、UI-07～12 仍 partial；穩定標題主選單與320×200原版 oracle 達整幀AE=0。完整開場、發行商畫面與兩次索引色盤內插已達99%門檻；ch02城鎮／商店、正式教會、service2／3正常輸入與多組AE0證據維持。故事對話現接`ch00_pre`97句、`ch00_post`13句、`ch01_pre`20句與`ch24_post`18句；第1戰後不再以測試清除對話，而是完整收框後同步隊伍，再經城鎮／整備冷讀至第2戰。 | 四個已接故事切片只剩未修改同狀態E2；下一個資料完整且玩家價值高的未接切片為raw ch22 post十個caller／89句。標題只剩精確音訊與原版完整啟動E2；教會只留DOSBox caller E2。service2／3依99%門檻不再列runtime阻擋。第29戰已結案，不再重開。 |

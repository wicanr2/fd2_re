...
| 5 | 戰場與戰間 UI 收尾 | UI-03、UI-07～12 仍 partial；故事對話現接`ch00_pre`97句、`ch00_post`13句、`ch01_pre`20句、`ch12_post`12句、`ch17_post`21句、`ch24_post`18句及raw`ch22_post`十個caller／56句。第13戰後12句已以具型別輸入保持跨scene順序，再同步、JOIN3、進`town_ch14`並通過存讀檔；第18戰後21句與第23戰後正式可達35句亦完成各自持續隊伍邊界。raw glyph格數已與Unicode rune數分離，後段`ASR-07`等多rune原版glyph可正確進位。 | 七個已接故事切片只剩未修改同狀態E2；下一個候選應從已有正式路徑且canonical RE充分的未接caller挑選，不重做`ch12_post`或`ch17_post`。標題、教會與service2／3只留既有E2限制；第29戰已結案。 |

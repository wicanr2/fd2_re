...
| 順序 | 工作 | 現況 | 下一個可驗收結果 |
|---:|---|---|---|
| 即時勘誤 | A4／A5 數字 | 2026-09-04 現代地圖人物為 selector 0–21、68、76、77、82，共 26 組／312 幀；76 是第三章普通追兵，77 是同章未知姓名的重裝隊長，82 是第 7–9 戰敵方劍士。四語內容各有 5,176 筆；繁中全為來源，簡中尚有 11 筆、日文 3,192 筆、英文 2,022 筆 `machine_draft`，不可只以劇情本文審校數冒充全包完成度 | 後續數字直接由 catalog 與語系檔重算，不手抄舊快照 |
...
> 玩家可見戰鬥介面文字；全量 validator 通過後，日文為 1,984 reviewed／
> 3,192 machine draft，英文為 3,154 reviewed／2,022 machine draft；四語資料完整與

...
| 4 | 玩家指令／法術／物品與敵方 AI 完整交易 | 敵方ID0已接完整presenter；ID1已完成#19/#21九張target compositor；ID2已完成#26/#27單張target compositor與#83 sample。ID6已完成#32/#33/#87、`fcos/fsin`五點座標、7張前導＋每目標12張＋相鄰目標9張`sub_2BA22`過場＋7張尾段的typed sequence/indexed compositor；五段HP與實際mode順序均已勘誤。正式AI的ID1/2/6仍是state-only數值路徑，不能冒稱畫面E1 | ID6下一步將 common prelude／actor phase、全部已閉合畫面、MP／HP／sample owner一次預建成正式Game presenter，再同時接玩家及敵方continuation；ID1/2仍須閉合外層owner。其後依頻度處理ID5／4／7／3。ID8現行map無敵方mask，僅新producer證據才提升；ID9–12仍須閉合各自owner |

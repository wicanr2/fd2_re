...
- [~] **ch22_pre control-flow**：固定 16-slot deactivate loop 已由 repeat_hint lowering 與 regression test 解開；尚待把 0x24618 演出與 0x11df2 palette/fade 兩個 native call 反組譯成 runtime beats，完成後再接 `story_ch23` binding。

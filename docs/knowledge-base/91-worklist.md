...
> **2026-09-05 A4 selector 32 追加：**最新統計是四十五組／540 幀，
> 尚缺 51 組。group 32 依原版 384..395 幀保留圓角巨型頭盔、黑色窄面罩、
> 正面淡青雙眼光、厚肩甲與短腿；沒有添加原圖未證實的武器。原版 `remap_mask`
> 是目的像素 LUT 區域而非角色換色層，現代候選使用固定深石板藍灰，不把灰階匯出
> 誤稱為原版色盤。身分未閉合，只以 selector 32 登錄。

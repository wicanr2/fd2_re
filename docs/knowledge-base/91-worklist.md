...
| 1 | 維護 handler 三態與 IDA 函式清冊 | `RE-CLOSED`、`DATA-READY`：2026-08-27由合法IDA 9.4重生1,305函式；全專案unknown位址足跡稽核後，只有10筆具caller／consumer／writer的窄語意獲准回填。語意索引現48筆，結果為產品46／runtime171／未知1,088。508個精確起點與524個range命中只表示曾被提及，不批次解除unknown。舊83 unknown call sites已拆為80已分類、3已知但未閉合、0真未知 | 只在新證據或 blocker 出現時更新語意索引；未分類函式不阻擋封包，但若代表性玩家抽樣揭露資料破壞或正式路徑缺口，才開窄RE切片 |
...
> 以合法IDA 9.4重生並完成足跡回填後，函式清冊為產品46／runtime171／未知1,088，將故事切片由舊17筆訂正為

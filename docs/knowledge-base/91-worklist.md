...
| 5 | 戰場與戰間 UI 收尾 | UI-03、UI-07～12 仍 partial；故事對話現接十個切片。新增`ch06_post`12句：active／inactive兩路以正式輸入分別完成8／4句、JOIN12正反例、`town_ch08`與存讀檔；第8戰後29／41 slots兩個合法邊界亦完成8句、全黑、JOIN5、同步、`town_ch09`與存讀檔。 | 十個已接故事切片只剩未修改同狀態E2；下一個候選從已有正式路徑且canonical RE充分的未接caller挑選，不重做已接切片；第29戰已結案。 |

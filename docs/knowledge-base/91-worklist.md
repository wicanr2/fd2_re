...
- [~] ch02/ch03 story handler slices：ch02_pre/ch02_post 已有 count-aligned dialogue 與 handler override，可依 scene line 範圍播放；ch03_post 僅接已證實的 ch04 scene3 lines0–3。ch03_pre 兩段 dialogue 尚無 `dialogue_contexts` 證據，禁止 generic story fallback，待補 FDTXT_004/raw mapping 後再接線。

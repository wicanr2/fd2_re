...
- [ ] **序章劇本 staging 機制 RE**(使用者指出 #3=劇本機制沒 RE 完整):反組譯章節0 handler
      0x3231b 進戰場後的「主角隊進場/佈署到定位」staging(進場位置/行軍路徑/佈署順序);
      doc23 §4 只 RE 過場對白 beats,未涵蓋 staging。remake 現硬擺 (11,11)。→ 忠實修 #3 的前提

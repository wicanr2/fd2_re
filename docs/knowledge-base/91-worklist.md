...
| 4 | 玩家指令／法術／物品與敵方 AI 完整交易 | 敵方ID0已接完整presenter；ID1已完成#19/#21九張target compositor；ID2已完成#26/#27單張target compositor與#83 sample。ID6的#32/#33/#87、`fcos/fsin`座標、7張前導＋每目標12張＋相鄰目標9張過場＋7張尾段，現已由正式Game owner一次預檢並接到玩家與敵方continuation；MP、五段HP、`Acted`、RNG均依Draw邊界發布且可整批回復，達indexed `RUNTIME-E1`。#87逐呼叫混音與E2仍缺 | ID1/2仍須閉合外層owner；其後依正常玩家／敵方producer頻度處理ID5／4／7／3。ID6只留逐呼叫音訊、同狀態逐幀／逐音訊E2，不重做已閉合handler |

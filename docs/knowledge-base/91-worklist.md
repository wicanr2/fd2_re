...
> 原資源 party montage，完成後才等待確認回到可編輯結語。這不是原版 terminal owner。
> 這不接 raw ch29 terminal handler，不消費停曲／`FDMUS_018`，也不改變一般玩家 E2、
> 精確 BIOS key mapping 或完整 montage owner 的未完成狀態。

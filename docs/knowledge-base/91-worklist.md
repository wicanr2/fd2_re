...
| 4 | 玩家指令／法術／物品與敵方 AI 完整交易 | 敵方ID0、玩家／敵方ID1／2／3／5／6／7／8／9均已有caller-specific indexed owner；玩家IDs10–12與受限class19玩家ID32亦達`RUNTIME-E1`。ID32正式owner已完整消費`0x27FC9→0x2111A→0x1CAC7`、原始#65/#91/#6/#80/#5、DAC插值、HP／RNG／Acted交易與rollback。ID4無已證實正常玩家producer；28／30／31沒有已證實正常玩家取得來源，均不以猜測列阻擋。 | 下一個結果是把已`RE-CLOSED`／`DATA-READY`的ID33共用段與`0x211A4`清除／回復專用tail接成正式owner，再依序完成34／35；已閉合IDs0–12與32不重做，同狀態逐幀／逐音訊另屬E2 |

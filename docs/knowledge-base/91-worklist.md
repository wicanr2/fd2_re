...
| 4 | 玩家指令／法術／物品與敵方 AI 完整交易 | 敵方ID0已接完整presenter；ID1已完成#19/#21九張target compositor；ID2已完成#26/#27單張target compositor與#83 sample。ID6已完成#32/#33/#87、`fcos/fsin`座標、7張前導＋每目標12張＋相鄰目標9張過場＋7張尾段，並有一次預建全部final targets且零partial output的admission builder；五段HP與實際mode順序均已勘誤。正式AI的ID1/2/6仍是state-only | ID6下一步只剩把 common `0x29164/0x2B659`、#87已證實selector、全批次畫面與原子MP／HP／Acted job接入Game，再同時接玩家及敵方continuation；ID1/2仍須閉合外層owner。其後依頻度處理ID5／4／7／3 |

...
| 4 | 玩家指令／法術／物品與敵方 AI 完整交易 | 敵方ID0已接完整presenter；ID1已完成#19/#21九張target compositor；ID2已完成#26/#27單張target compositor與#83 sample。ID6已修正mode6回傳7，完成#32/#33/#87、`fcos/fsin`五點座標、十二張mode4→target→mode5 draw plan、counter與secondary effect indexed compositor；mode5第二張是numeric marker而非完成，錯誤名稱已勘誤。正式AI的ID1/2/6仍是state-only數值路徑，不能冒稱畫面E1 | 先閉合ID1/2外層MP／HP／音訊發布owner；ID6下一步是共用`0x2A6BD` actor/tail與numeric marker consumer，才接正常producer presenter。其後依頻度處理ID5／4／7／3。ID8現行map無敵方mask，僅新producer證據才提升；ID9–12仍須閉合各自owner |

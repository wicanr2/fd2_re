...
| 5 | 戰場與戰間 UI 收尾 | UI-03、UI-07～12 仍 partial；故事對話現接十二個切片。新增`ch16_post`26句：roster有／無角色18兩路以正式輸入分別完成23／22句、60→61／61→62 frontier、JOIN16、`town_ch18`與存讀檔；第7、8、16戰後亦保持各自分支與城鎮邊界。 | 十二個已接故事切片只剩未修改同狀態E2；下一個候選從已有正式路徑且canonical RE充分的未接caller挑選，不重做已接切片；第29戰已結案。 |

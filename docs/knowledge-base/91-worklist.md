...
- [~] ch05/ch06 pre-handler：FDTXT_006 #0 的 18 句來源已確認，但跨 4 個 story scene；現有 compiler 明確 fail-closed，待新增跨-scene dialogue segment 原語後再接 `story_ch06`，暫不 generic fallback 取代原版順序。

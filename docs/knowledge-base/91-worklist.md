...
| 5 | 戰場與戰間 UI 收尾 | UI-03、UI-07～12 仍 partial；故事對話現接九個切片，新增`ch07_post`8句。第8戰後29／41 slots兩個合法邊界均以正式輸入完成8句、全黑、JOIN5、同步、`town_ch09`與存讀檔；其他已接切片亦完成各自分支與持續隊伍邊界。 | 九個已接故事切片只剩未修改同狀態E2；下一個候選從已有正式路徑且canonical RE充分的未接caller挑選，不重做已接切片；第29戰已結案。 |

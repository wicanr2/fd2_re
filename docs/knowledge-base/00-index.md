...
| 全戰役原版一致目標：門檻、章工作單元、開工順序 | [`111` 目標提示詞](111-goal-original-parity-campaign-20260915.md)，進度台帳 `parity-campaign-progress.json` | 逐章收據自己的散文摘要 |
| 目前這一章的工作單元（順序、門檻、交付物） | [`112` 第七章提示詞](112-goal-ch07-parity-and-sample-sheet-20260916.md)（做完就換下一章的） | 聊天裡貼的舊版提示詞 |

...
`100`對話視窗 · `101`回合橫幅（呈現） · `102`戰果訊息 · `103`戰鬥台座 z 序 · `104`回歸基線審查 · `105`回合橫幅（節奏、字樣與版面） · `106`物理攻擊：結算鏈、反擊條件與傷害公式 · `107`六個暫時狀態的語意 · `108`地形移動成本表與移動確認游標 · `109`標題 START 到羅德鎮的整段對照

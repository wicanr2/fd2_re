...
| full-screen battle presentation | 40–50% | FIGANI/AFM、部分 status frame與局部 pixel-equal slices可重播；2026-08-10 戰鬥狀態欄姓名已由 TTF fallback 改接 FDOTHER#4 16×16 glyph，重製端 E1 artifact [`battle-native-name-remake.png`](../figures/battle-native-name-remake.png) 可重現；command/spell/item完整 presentation、音效與 palette/timing sequence、一般玩家同狀態 DOSBox E2 仍缺 |

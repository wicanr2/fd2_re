# v.1.0.1-20260907 發行說明

這是《炎龍騎士團 2》潔淨室重製的第一個穩定里程碑，也是 `v.1.0.0-20260907`
私人素材 CI 邊界修正後的正式發行。版本字串、Git tag、GitHub Release、程式建置
資訊、封包檔名與 `dist-all/` 目錄一律使用 `v.1.0.1-20260907`。

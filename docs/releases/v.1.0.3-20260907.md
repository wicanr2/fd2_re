...
> **撤銷穩定版資格（2026-09-07）：**實際玩家啟動證實本版未預設載入完整戰役；
> 標題原版分離素材缺失時又會直接顯示預載第一關。第一關因而缺少完整第 0 章
> 對話／演出與音樂，本機完整版亦誤選封存型素材包。下列內容只保留為當時發行
> 收據，不再代表可玩驗收。既有 Release／tag 不覆寫；修正後另發新版本。

這是《炎龍騎士團 2》潔淨室重製第一次嘗試的 1.0 系列里程碑；其穩定版資格已依
上述實機回報撤銷。它延續前三個保留但未建立

...
> **完整重製自評：76／100（約 76%）。尚餘約 24% 的產品整合、忠實度驗收與發行工作。**
...
| 操作介面與原版視覺忠實度 | 15 | 11 | ch02 城鎮／商店已有多個整幀相同結果；普通攻擊固定 fixture 的319×199內容區亦達 AE=0。外部末關候選另由普通鍵盤 CONTINUE 抵達第30戰並啟用正式 indexed compositor，已排除舊 PNG fallback 雜訊；教會、整備、動畫相位及其他章節仍缺一般玩家同狀態 E2 |

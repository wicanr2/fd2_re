...
| 操作介面與原版視覺忠實度 | 15 | 14 | ch02 城鎮／商店與普通攻擊固定fixture已有整幀或內容區AE=0；序章97句、第1戰後13句、第2戰前20句、第13戰後12句、第18戰後21句及第23戰後十個caller／56句故事對話，均已由raw control接入原生框、逐字、嘴型及收框。第13戰後正式路徑保持跨場景句序，完成同步、JOIN3、`town_ch14`與存讀檔；第18戰後完成JOIN21／7與`town_ch19`；第23戰後正式可達分支播放35句，再同步、存檔、冷讀並完成15人整備。外部末關候選另由普通鍵盤CONTINUE抵達並操作第30戰；同一raw狀態與合法相位組合已達320×200整幀AE=0。固定晚期槽整備與正式教會主選單亦有同狀態或原始資源oracle的AE=0；仍缺故事對話DOSBox同狀態、教會DOSBox caller與其他章節代表性E2 |

...
| 三平台發行與推廣 | 10 | 2 | Linux 已通過 Docker／Xvfb 建置與啟動擷圖；Windows x86_64 現可由無網路、指定UID/GID的一次性容器產生GUI PE與ZIP並驗證雜湊。macOS已具真正`.icns`的工作流程；仍缺Windows真機、macOS CI、Linux AppImage新工具鏈、最終三平台封包與推廣影片 |
| **總計** | **100** | **85** | **尚未達到發行候選版** |

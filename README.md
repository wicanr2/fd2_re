...
| 操作介面與原版視覺忠實度 | 15 | 14 | ch02 城鎮／商店與普通攻擊固定fixture已有整幀或內容區AE=0；九個故事對話切片已由raw control接入原生框、逐字、嘴型及收框。新增第8戰後8句，正式29／41-slot邊界均完成全黑、JOIN5、同步、`town_ch09`與存讀檔；第13、18、20、23戰後亦保持各自分支、入隊與城鎮／整備邊界。外部末關候選由普通鍵盤CONTINUE抵達並操作第30戰；同一raw狀態與合法相位組合已達320×200整幀AE=0。仍缺故事對話DOSBox同狀態、教會DOSBox caller與其他章節代表性E2 |

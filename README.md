...
| 隊伍持續與原生存讀檔 | 重製格式可用，current-runtime SAVE／LOAD 與增援／JOIN raw 同步已有窄 E1；外部晚期有效槽已由普通LOAD抵達19人整備與第30戰 | 補第29戰勝利當下寫槽的完整來源鏈，並抽驗代表性章節的金錢、HP／MP、物品、裝備與隊伍順序；長程漂移由人工回報建立窄重現案例 |

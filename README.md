...
| 操作介面與原版視覺忠實度 | 15 | 11 | ch02 城鎮／商店已有多個整幀相同結果；普通攻擊固定 fixture 的319×199內容區亦達 AE=0。外部末關候選另由普通鍵盤 CONTINUE 抵達第30戰；IDA閉合並接通原版 `FDOTHER #55` 輔助底面後，同狀態最佳raw相位由AE=16,281降至3,242。仍缺完整來源的一般玩家E2，以及教會、整備與其他章節的代表性比對 |
...
320×200差異由16,281降至3,242像素。它是可重生的 E1 分階段診斷，不冒稱另一次

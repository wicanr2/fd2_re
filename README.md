...
- 戰鬥指令、法術、物品與敵方人工智慧已有多條正式 E1；`0x20C6F` 已恢復的物品 type 5–24 數值交易均已接通。`0x1A866` 的 selector 1→0／2 狀態倒數也已接到已證實的非玩家／玩家階段 owner。仍缺的是部分未知法術／複合指令、原版 indexed 到期訊息與狀態圖示，以及精確演出／音訊驗證。

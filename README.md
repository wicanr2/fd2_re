...
- 戰鬥指令、法術、物品與敵方人工智慧已有多條正式 E1；`0x20C6F` 已恢復的物品 type 5–24 數值交易均已接通。仍缺的是部分未知法術／複合指令、selector 1／2 狀態到期 owner、原版狀態圖示，以及精確演出／音訊驗證。

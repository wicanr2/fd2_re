...
| 操作介面與原版視覺忠實度 | 15 | 14 | ch02 城鎮／商店與普通攻擊固定fixture已有整幀或內容區AE=0；十七個故事對話切片已由原始控制碼接入原生框、逐字、嘴型及收框。第21戰後六組分支呼叫共30句現保存逐句上下框與頁面；成功臂正式走完26句、ACT63／64、天空之鑰動畫、同步、`town_ch22`與存讀檔，材料不足四句亦由原始資料等值驗證。外部末關候選由普通鍵盤CONTINUE抵達並操作第30戰；同一原始狀態與合法相位組合已達320×200整幀AE=0。仍缺故事對話DOSBox同狀態、教會DOSBox呼叫端與其他章節代表性E2 |

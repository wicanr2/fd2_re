...
> **完整重製自評：81／100（約 81%）。尚餘約 19% 的產品整合、忠實度驗收與發行工作。**
...
| 戰鬥規則、玩家指令與敵方 AI | 20 | 18 | 正常產生端的主要交易與 indexed owner 已達 E1；固定晚期槽現由正式 LOAD／整備進第30戰，再經 END／YES、原始敵軍陣容與 indexed 演出完成一輪控制權交接。玩家普通攻擊、敵方指令13、指令24及指令29多目標正式呈現回歸亦通過，仍缺原版同狀態逐音訊／逐幀 E2 |

...
func TestBuildNativeCommand2022TailSchedulePreservesRawRows(t *testing.T) {
	...
	want := [][6]int{{20, 0xcc, 13, 4, 0xc0, 0x69}, {21, 0xd9, 13, 4, 0xc0, 0x69}, {22, 0xaa, 13, 3, 0x23, 0x5e}, {25, 0xbf, 13, 5, 0xc0, 0x5e}, {26, 0x8a, 9, 3, 0xc0, 0x5e}, {27, 0x9e, 12, 2, 0xc0, 0x5e}}
	...
	if len(rows[0].ExtraSampleFrameIndices) != 0 || len(rows[1].ExtraSampleFrameIndices) != 0 || len(rows[2].ExtraSampleFrameIndices) != 1 || rows[2].ExtraSampleFrameIndices[0] != 7 || len(rows[3].ExtraSampleFrameIndices) != 0 || len(rows[4].ExtraSampleFrameIndices) != 0 || len(rows[5].ExtraSampleFrameIndices) != 0 {

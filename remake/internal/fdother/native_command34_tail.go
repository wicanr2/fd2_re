...
func BuildNativeCommand34TailSchedule() ([]NativeCommand34StageSchedule, error) {
	...
	rows := []NativeCommand34StageSchedule{
		...
		{CommandID: 18, EffectStart: 0x7e, EffectFrames: 12, EffectSample: 7, ExtraSampleFrames: []int{4}, MaskIndex: 0x48},
		{CommandID: 19, EffectStart: 0x93, EffectFrames: 11, EffectSample: 8, ExtraSampleFrames: []int{3, 6}, MaskIndex: 0xd8},
	}

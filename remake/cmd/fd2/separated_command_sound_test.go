...
func TestSeparatedCommandSoundBanksDecodeWithoutOriginalArchive(t *testing.T) {
	...
	want := map[int]int{
		50: 5, 53: 4, 77: 4, 78: 1, 80: 16, 82: 2, 83: 4, 84: 3, 85: 2, 86: 2, 87: 4, 88: 2, 90: 3,
...
func TestInstallSeparatedCommandSoundsUsesTitleBankSelectors(t *testing.T) {
	...
	if string(g.sfxTitleANI1) != "ani1" {
		t.Fatalf("ANI #1 companion=%q", g.sfxTitleANI1)
	}
}

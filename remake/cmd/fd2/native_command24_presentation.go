...
func (g *Game) startNativeCommand24Presentation(actor, target *battle.Unit, then func([]battle.NativeCommand24Damage)) error {
	...
	if g == nil || g.st == nil || g.rng == nil || actor == nil || target == nil ||
		g.nativeCmd24Presentation != nil || g.nativeCmd29Presentation != nil || g.nativeCmd0Presentation != nil || g.nativeCmd1Presentation != nil || g.nativeCmd6Presentation != nil || g.nativeHealPresentation != nil ||

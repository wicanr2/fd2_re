...
func (g *Game) startNativeCommand2Presentation(actor, confirmed *battle.Unit, then func([]battle.NativeCommandDamageResult)) error {
	...
	if g == nil || g.st == nil || actor == nil || confirmed == nil || g.nativeCommandScene == nil ||
		...
		g.nativeCmd3Presentation != nil || g.nativeCmd5Presentation != nil || g.nativeCmd6Presentation != nil || g.nativeCmd7Presentation != nil || g.nativeCmd8Presentation != nil || g.nativeCmd24Presentation != nil || g.nativeCmd29Presentation != nil ||
	...
	if figaniPath == "" || bgPath == "" || taiPath == "" || fdotherPath == "" || fdtxtPath == "" {
		return errors.New("native command2 player-provided archives unavailable")
	}

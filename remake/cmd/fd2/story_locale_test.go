...
func TestReviewedChapterTwoCampaignTranslationsAndItemEntities(t *testing.T) {
	wants := map[string]map[string]string{
		...
		"en": {
			...
			"legacy.json.remake.assets.scenarios.campaign_full.nodes.retreat_ch02.lines.0.text":     "Fall back! Regroup, then look for another chance to counterattack…",
			"legacy.json.remake.assets.scenarios.campaign_full.nodes.rumor_ch02.lines.0.text":       "Rumor has it that this place keeps some special goods off the shelves… (Press Shift+F1 in front of the tavern.)",
			...
			"legacy/line/5bf145f103fe/scenes/1/lines/8/speaker-name":                                "Villager",
			...
			"legacy/line/5bf145f103fe/scenes/1/lines/10/speaker-name":                               "Villager",
			"legacy/line/5bf145f103fe/scenes/1/lines/10/text":                                       "Thank you for your help. Please accept this small token of our gratitude.",
			"legacy/line/5bf145f103fe/scenes/1/lines/11/speaker-name":                               "Villager",

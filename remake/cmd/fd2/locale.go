...
var officialLocaleContract = map[string]localeEntryContract{
	...
	"battle.item.empty_slot":              {[]string{}, "legacy.go.remake.cmd.fd2.main.l5065-c14"},
	"battle.item.data_incomplete":         {[]string{}, "legacy.go.remake.cmd.fd2.main.l5070-c14"},
	"battle.item.unusable":                {[]string{}, "legacy.go.remake.cmd.fd2.main.l5078-c14"},
	"battle.item.effect_complete":         {[]string{"%02X"}, "legacy.go.remake.cmd.fd2.main.l5085-c14"},
	"battle.item.choose_target":           {[]string{"%02X"}, "legacy.go.remake.cmd.fd2.main.l5092-c14"},
	"battle.item.effect_unverified":       {[]string{"%02X"}, "legacy.go.remake.cmd.fd2.main.l5095-c14"},
	"battle.item.choose_destination":      {[]string{"%02X"}, "legacy.go.remake.cmd.fd2.main.l6278-c14"},
	"battle.item.damage_presenting":       {[]string{"%02X"}, "legacy.go.remake.cmd.fd2.main.l6283-c14"},
	...
	"title.load.controls":                 {[]string{}, "legacy.go.remake.cmd.fd2.title.l826-c22"},

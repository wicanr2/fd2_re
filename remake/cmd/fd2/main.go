...
func (g *Game) confirm() {
	...
	if g.nativeCommand0Targeting {
		...
		if id == 33 {
			actor := g.sel
			result, err := g.st.ExecuteNativeCompoundCommand33(actor, tgt, g.nativeRNGState)
			if err != nil {

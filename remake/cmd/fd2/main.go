...
func (g *Game) confirm() {
	...
	if g.nativeCommand0Targeting {
		...
		if id == 34 {
			actor := g.sel
			result, err := g.st.ExecuteNativeCompoundCommand34(actor, tgt, g.nativeRNGState)
			if err != nil {

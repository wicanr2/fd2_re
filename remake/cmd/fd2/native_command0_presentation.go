...
func (g *Game) startNativeCommand0Presentation(actor, target *battle.Unit, then func([]battle.NativeCommandDamageResult)) error {
	...
	if g == nil || g.st == nil || actor == nil || target == nil || g.nativeCommandScene == nil ||
		...
		g.nativeCmd1Presentation != nil || g.nativeCmd2Presentation != nil || g.nativeCmd3Presentation != nil || g.nativeCmd5Presentation != nil || g.nativeCmd6Presentation != nil || g.nativeCmd7Presentation != nil || g.nativeCmd8Presentation != nil || g.nativeCmd9AIPresentation != nil ||
	...
	if err := g.requireSeparatedCommandSounds(schedule.SoundResource, 0, schedule.SoundIndex); err != nil {
		return fmt.Errorf("native command0 sounds: %w", err)
	}
